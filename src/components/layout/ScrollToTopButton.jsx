...
export default function ScrollToTopButton() {
  ...
  return (
    <div className="fixed bottom-24 right-6 md:bottom-28 md:right-10 z-[1500] flex flex-col gap-2 md:gap-3">
      {showTop && (
        <button
          onClick={scrollToTop}
          className="w-10 h-10 md:w-11 md:h-11 bg-black text-white rounded-full shadow-lg flex items-center justify-center hover:scale-110 active:scale-95 transition-all animate-in slide-in-from-bottom duration-500 opacity-60 hover:opacity-100"
