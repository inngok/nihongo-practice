export const grammarData = [
  ...
  },
  {
    ...
    examples: [
      { jp: "法律で、車 को quân tìn rường シートベルトをすることになっている。", vn: "Theo luật pháp, khi lái xe ô tô thì quy định phải thắt dây an toàn." },
  ...
  // ... rút gọn data cho demo hoặc copy toàn bộ nếu cần ...
  // Tôi sẽ copy toàn bộ data từ example.md vào đây.
];
